...
if  DEPTH_MAX > 3:
    dfPreviousDepth = pd.read_csv("PD_ARGMAX_BACKWARD_" +str(DEPTH_MAX-1) + "Epsilon" +str(epsilon) + "BETA" + str(BETA) + "ITMAX" + str(IT_MAX)+".csv", index_col = 0)
...
df.to_csv("PD_ARGMAX_BACKWARD_" +str(DEPTH_MAX) + "Epsilon" +str(epsilon) + "BETA" + str(BETA) + "ITMAX" + str(IT_MAX)+ ".csv")
